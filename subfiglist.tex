...
\captionsetup{type=figure}
\begin{subfiglist*}[w=10cm]{1 2\\3 4}%{1 @{\color{red}\rule{2ex}{\subfiglistlineheight}} 2\\}%{ 1 @{asdf} {2} { 3 \\ 4 } \\[1ex] 5 }
%  \tl_show:N \subfiglist_parsed_spec_tl \error
%  \subfiglist_setup_file:nnn {} {1} { figures/01 }
%  \subfiglist_setup_file:nnn {} {2} { figures/02 }
\subfiglistfile [t=0ex] {1} {figures/04}
\subfiglistfile {2} {figures/04}
\subfiglistfile {3} {figures/04}
\subfiglistfile {4} {figures/04}

\subfiglistlabel [v=t,h=l,b=none] { 1 } {} 
\subfiglistoverlay { 2 } { asdf }
