...
\begin{subfiglist*}{1 @{\color{red}\rule{2ex}{\subfiglistlineheight}} 2\\}%{ 1 @{asdf} {2} { 3 \\ 4 } \\[1ex] 5 }
...
\dim_new:N \tempb_dim
%
\subfiglist_dimension_vmode_newline:NnV \subfiglist_dimensioned_spec_tl { 205.16667pt } \subfiglist_tempb_tl
