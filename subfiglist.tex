...
\begin{subfiglist*}{1@{\hspace{1pt}}2\\[0pt]3@{\hspace{3pt}}4}%{1 @{\color{red}\rule{2ex}{\subfiglistlineheight}} 2\\}%{ 1 @{asdf} {2} { 3 \\ 4 } \\[1ex] 5 }
%  \tl_show:N \subfiglist_parsed_spec_tl \error
%  \subfiglist_setup_file:nnn {} {1} { figures/01 }
%  \subfiglist_setup_file:nnn {} {2} { figures/02 }
\subfiglist_setup_dummy:nnn {} {1} {1:1}
\subfiglist_setup_dummy:nnn {} {2} {1}
\subfiglist_setup_dummy:nnn {} {3} {1}
\subfiglist_setup_dummy:nnn {} {4} {1}
...
\dim_use:N \tempa_dim\\
\dim_use:N \tempb_dim\\
\subfiglist_is_nan:VTF \c_nan_fp { true } { false }

%\tl_to_str:N \subfiglist_dimensioned_spec_tl
