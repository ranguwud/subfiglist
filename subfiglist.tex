...
%  \tl_show:N \subfiglist_spec_tl \error
  \subfiglist_setup_dummy:nnn {top=1pt} {1} { 1 }
  \subfiglist_setup_dummy:nnn {bottom=3pt} {2} { 1 }
...
\subfiglist_get_key_figures_line:NNNV \temp_fp \tempa_dim \tempb_dim \subfiglist_tempb_tl
\fp_use:N \temp_fp,
\dim_use:N \tempa_dim,
\dim_use:N \tempb_dim
\end{subfiglist}
