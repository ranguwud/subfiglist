...
%
%       \makeatletter\input{packages/caption/caption}\makeatother.
%
...
\input{preamble/uselocalpackage}
\usepackage{calc}
\usepackage{float}
...
%\let\stss \subfiglist_tokenize_spec_str:nN
%\let\spst \subfiglist_parse_spec_tokens:VN
%\def\sii{\subfiglist_is_integer:nTF}
%\def\sif{\subfiglist_is_float:nTF}
%\def\stie{\subfiglist_tl_if_eq:nnTF}
%\tl_new:N \sstt %\subfiglist_spec_token_tl
%\tl_new:N \sst %\subfiglist_spec_tl
%\tl_new:N \subfiglist_tempc_tl
%\ExplSyntaxOff
%\sii {34} t f\\
%\stie{ab}{ab }tf\\
%\stss { 1 @{asdf} {2} { 4 \\ 3 } \\[1ex] 5 } \sstt
%\spst \sstt \sst
\ExplSyntaxOn
\cs_generate_variant:Nn \msg_error:nnnn { nnnc }
%\tl_show:N\sst\error
%\tl_set:Nn \subfiglist_tempa_tl { abc }
%\subfiglist_tl_set_tail:NV \subfiglist_tempb_tl \subfiglist_tempa_tl
%\tl_to_str:N \subfiglist_tempb_tl
xxx
%\tl_to_str:N \subfiglist_spec_canvas_nums_tl
%\subfiglist_verify_spec_canvas_nums:NNN
%  \subfiglist_spec_canvas_nums_tl
%  \subfiglist_spec_canvas_nums_sorted_tl
%  \subfiglist_canvas_count_int
\begin{subfiglist*}{1@{\hspace{10pt}}2\\[10pt]3@{\hspace{30pt}}4}%{1 @{\color{red}\rule{2ex}{\subfiglistlineheight}} 2\\}%{ 1 @{asdf} {2} { 3 \\ 4 } \\[1ex] 5 }
%  \tl_show:N \subfiglist_parsed_spec_tl \error
%  \subfiglist_setup_file:nnn {} {1} { figures/01 }
%  \subfiglist_setup_file:nnn {} {2} { figures/02 }
\subfiglist_setup_file:nnn {} {1} {figures/02}
\subfiglist_setup_file:nnn {} {2} {figures/02}
\subfiglist_setup_file:nnn {} {3} {figures/02}
\subfiglist_setup_file:nnn {} {4} {figures/02}
  
  \tl_to_str:N \subfiglist_parsed_spec_tl\\
%  \dim_use:N\subfiglist_newline_correction_dim
%  \includegraphics{figures/01}\\[-1ex]
%  \includegraphics{figures/02}
%  \subfiglist_setup_dummy:nnn {} {3} { 1.23 }
%  \subfiglist_setup_dummy:nnn {} {4} { 4:3 }
%  \subfiglist_setup_dummy:nnn {} {5} { 4:3 }
  
%  \subfiglist_tl_set_tail:NV \subfiglist_tempa_tl \subfiglist_parsed_spec_tl
%  \subfiglist_tl_set_unwrapped:NV \subfiglist_tempa_tl \subfiglist_tempa_tl
%  \subfiglist_tl_set_tail:NV \subfiglist_tempb_tl \subfiglist_tempa_tl
...
\dim_new:N \tempb_dim
%
\subfiglist_get_aspect_hmode_subblock:NNNV \temp_fp \tempa_dim \tempb_dim \subfiglist_parsed_spec_tl
%
\fp_use:N \temp_fp\\
\dim_use:N \tempa_dim\\
\dim_use:N \tempb_dim\\

\subfiglist_dimension_hmode_subblock:NnV \subfiglist_dimensioned_spec_tl { 200pt } \subfiglist_parsed_spec_tl

\prop_show:N \subfiglist_canvas_prop
\tl_show:N \subfiglist_dimensioned_spec_tl %\error
%\dim_use:N \subfiglist_line_height_dim\\
%
...
%  \subfiglist_tl_set_unwrapped:NV \subfiglist_tempb_tl \subfiglist_tempb_tl
%%  \tl_to_str:N \subfiglist_tempb_tl\\
%  \subfiglist_use:c { subfiglist_put_ \subfiglist_tempa_tl :V } \subfiglist_tempb_tl
%}
\subfiglist_put_subblock:V \subfiglist_dimensioned_spec_tl
%
%%\subfiglist_put_lineheight:n { 80.76108pt }
%%\subfiglist_put_canvas:n { 1 }
%%\subfiglist_put_separator:n  { ab }
%%\subfiglist_put_canvas:n { 2 }
%%\color{red}\rule{2ex}{\subfiglistlineheight}
\end{subfiglist*}
\end{document}