...
%  \tl_show:N \subfiglist_spec_tl \error
  \subfiglist_setup_dummy:nnn {left=2pt} {1} { 1 }
...
\subfiglist_dimension_line:NnV \subfiglist_dimensioned_spec_tl { 25.16667pt } \subfiglist_tempb_tl
\dim_use:N \subfiglist_line_height_dim

  \prop_show:N \subfiglist_canvas_prop \error
  \tl_show:N \subfiglist_dimensioned_spec_tl
\end{subfiglist}
\end{document}